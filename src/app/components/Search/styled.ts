...
import {
  UilSearch as SearchIconIC, UilLocationPoint as LocationIconIC
...
`;
export const SearchIcon = styled(SearchIconIC)`
  margin-left: 1.2rem;
  fill: #4a6fa1;
`;
...
`;
export const LocationIcon = styled(LocationIconIC)`
  margin-right: 1.2rem;
  fill: #4a6fa1;
`;
